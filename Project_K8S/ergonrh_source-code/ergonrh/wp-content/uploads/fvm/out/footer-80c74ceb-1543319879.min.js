...
/* info: http://www.ergonrh.com.br/wp-content/themes/salient/js/magnific.js */
...
/* info: http://www.ergonrh.com.br/wp-content/themes/salient/js/isotope.min.js */
/*!
...
/* info: http://www.ergonrh.com.br/wp-content/themes/salient/js/superfish.js */
...
/* info: http://www.ergonrh.com.br/wp-content/themes/salient/js/init.js */
...
var $smoothActive=$('body').attr('data-smooth-scrolling');var $smoothCache=($smoothActive==1)?true:!1;if($smoothActive==1&&$(window).width()>690&&$('body').outerHeight(!0)>$(window).height()&&Modernizr.csstransforms3d&&!navigator.userAgent.match(/(Android|iPod|iPhone|iPad|IEMobile|Opera Mini)/)){niceScrollInit()}else{$('body').attr('data-smooth-scrolling','0')}
...
function clientsCarouselInit(){$('.carousel.clients').each(function(){var $that=$(this);var columns;var $autoRotate=(!$(this).hasClass('disable-autorotate'))?true:!1;(parseInt($(this).attr('data-max')))?columns=parseInt($(this).attr('data-max')):columns=5;if($(window).width()<690&&$('body').attr('data-responsive')=='1'){columns=2;$(this).addClass('phone')}
...
$enableGradient=($(this).attr('data-enable_gradient')=='true')?true:!1;if($enableGradient){if($overlay1=='#ffffff'&&$overlay2=='transparent')$overlay2='rgba(255,255,255,0.001)';if($overlay1=='transparent'&&$overlay2=='#ffffff')$overlay1='rgba(255,255,255,0.001)';if($gradientDirection=='top_to_bottom'){if($overlay2=='transparent'||$overlay2=='rgba(255,255,255,0.001)'){$rowOverlayCSS+='.row-bg-wrap.instance-'+i+':after { background: linear-gradient('+$gradientDirectionDeg+','+$overlay1+' 0%,'+$overlay2+' 75%);  opacity: '+$overlayOpacity+'; }'}
...
var $testimonialGroupCells=($(this).parents('.testimonial_slider').attr('data-style')=='multiple_visible_minimal')?true:!1;imagesLoaded($element,function(instance){$that.flickity({contain:!0,draggable:!0,groupCells:$testimonialGroupCells,lazyLoad:!1,imagesLoaded:!0,percentPosition:!0,prevNextButtons:!1,pageDots:!0,resize:!0,setGallerySize:!0,wrapAround:!0,autoPlay:$autoplay,accessibility:!1});$that.parents('.testimonial_slider').css('opacity','1')})})}
...
function videoBGInit(){setTimeout(function(){resizeVideoToCover();$('.video-color-overlay').each(function(){$(this).css('background-color',$(this).attr('data-color'))});$('.nectar-video-wrap').each(function(i){if($(this).find('video').length==0)return;var $headerVideo=($(this).parents('#page-header-bg').length>0)?true:!1;var $that=$(this);var videoReady=setInterval(function(){if($that.find('video').get(0).readyState>3){$that.transition({'opacity':'1'},400);$that.find('video').transition({'opacity':'1'},400);$that.parent().find('.video-color-overlay').transition({'opacity':'0.7'},400);if($headerVideo==!0){pageHeaderTextEffect()}
...
$mobileNavSelector=($('.off-canvas-menu-container.mobile-only').length>0)?'.off-canvas-menu-container.mobile-only ':'#mobile-menu .container ';$($mobileNavSelector+'.megamenu > ul > li > a').each(function(){if($(this).text()=='â€“'){$navLIs=$(this).parent().find('> ul > li').clone();$(this).parent().find('ul').remove();$(this).parent().parent().append($navLIs);$(this).parent().remove()}});var $bodyBorderHeaderColorMatch=($('.body-border-top').css('background-color')=='#ffffff'&&$('body').attr('data-header-color')=='light'||$('.body-border-top').css('background-color')==$('#header-outer').attr('data-user-set-bg'))?true:!1;var $bodyBorderWidth=($('.body-border-right').length>0)?$('.body-border-right').width():0;var $resetHeader;function mobileBreakPointCheck(){var $mobileBreakpoint=($('body[data-header-breakpoint]').length>0&&$('body').attr('data-header-breakpoint')!='1000')?parseInt($('body').attr('data-header-breakpoint')):1000;var $withinCustomBreakpoint=!1;if($mobileBreakpoint!=1000){if($('body[data-user-set-ocm="1"][data-slide-out-widget-area-style="slide-out-from-right-hover"]').length==0&&window.innerWidth>1000&&window.innerWidth<=$mobileBreakpoint){$withinCustomBreakpoint=!0}}
...
var $bodyBorderHeaderColorMatch=($('.body-border-top').length>0&&$('.body-border-top').css('background-color')=='#ffffff'&&$('body').attr('data-header-color')=='light'||$('.body-border-top').length>0&&$('.body-border-top').css('background-color')==$('#header-outer').attr('data-user-set-bg'))?true:!1;if($('#header-outer[data-remove-fixed="1"]').length==0&&$('body.mobile').length==0&&$bodyBorderHeaderColorMatch){var headerResize=$('#header-outer').attr('data-header-resize');if(headerResize==1){$(window).off('scroll.headerResizeEffect');if($(window).scrollTop()==0){$(window).on('scroll.headerResizeEffect',smallNav);if($('#header-outer[data-full-width="true"][data-transparent-header="true"]').length>0&&$('.body-border-top').length>0&&$bodyBorderHeaderColorMatch==!0&&$('#header-outer.pseudo-data-transparent').length>0){$('#header-outer[data-full-width="true"] header > .container').stop(!0,!0).animate({'padding':'0'},{queue:!1,duration:250,easing:'easeOutCubic'})}}else{$(window).on('scroll.headerResizeEffect',bigNav)}}else{$(window).off('scroll.headerResizeEffectOpaque');$(window).on('scroll.headerResizeEffectOpaque',opaqueCheck)}}}
...
var shrinkNum=6;var extraHeight=($('#wpadminbar').length>0)?$('#wpadminbar').height():0;var $bodyBorderHeaderColorMatch=($('.body-border-top').css('background-color')=='#ffffff'&&$('body').attr('data-header-color')=='light'||$('.body-border-top').css('background-color')==$('#header-outer').attr('data-user-set-bg'))?true:!1;var $scrollTriggerOffset=($('body.material').length>0)?150:0;if($('#header-outer[data-shrink-num]').length>0)shrinkNum=$('#header-outer').attr('data-shrink-num');function smallNav(){var $offset=$(window).scrollTop();var $windowWidth=$(window).width();if($offset>$scrollTriggerOffset&&$windowWidth>1000&&$('body.material-ocm-open').length==0){if($('body.material').length>0){if($('#search-outer.material-open').length==0){$('#header-outer[data-transparent-header="true"] .bg-color-stripe').css('transition','none')}
...
isotopeCatSelection();var completed=0;var windowLocation=window.location.href.replace(window.location.hash,'');function facebookShare(){windowLocation=window.location.href.replace(window.location.hash,'');window.open('http://www.facebook.com/sharer/sharer.php?u='+windowLocation,"facebookWindow","height=380,width=660,resizable=0,toolbar=0,menubar=0,status=0,location=0,scrollbars=0")
return!1}
function googlePlusShare(){windowLocation=window.location.href.replace(window.location.hash,'');window.open('http://plus.google.com/share?url='+windowLocation,"googlePlusWindow","height=380,width=660,resizable=0,toolbar=0,menubar=0,status=0,location=0,scrollbars=0")
return!1}
...
if($('a.pinterest-share:not(.sharing-default-minimal a.pinterest-share)').length>0&&$('body[data-button-style="rounded"]').length==0||$('#project-meta a.pinterest-share').length>0||$('#single-meta a.pinterest-share').length>0||$('#single-below-header .pinterest-share').length>0){$.getJSON('http://api.pinterest.com/v1/urls/count.json?url='+windowLocation+'&callback=?',function(data){if((data.count!=0)&&(data.count!=undefined)&&(data.count!=null)){$('.pinterest-share a span.count, a.pinterest-share span.count').html(data.count)}else{$('.pinterest-share a span.count, a.pinterest-share span.count').html(0)}
...
function updateMagPrettyPhotoGallery(){$('.portfolio-items').each(function(){var $currentCat=$(this).attr('data-current-cat');if($(this).is('[data-lightbox-only="true"]')){$(this).find('.col').each(function(){$(this).find('a.gallery').removeClass('gallery').removeClass('magnific');if($(this).is($currentCat)){$(this).find('.work-info a').addClass('gallery').addClass('magnific')}})}else if($(this).find('.work-item.style-1').length>0){$(this).find('.col').each(function(){$(this).find('a.gallery').removeClass('gallery').removeClass('magnific');if($(this).is($currentCat)){$(this).find('.work-info .vert-center a:first-of-type').addClass('gallery').addClass('magnific')}})}})}
...
if($('body[data-fancy-form-rcs="1"]').length>0){$('input[type="checkbox"]').each(function(){$id=$(this).attr('id');if(typeof $id!==typeof undefined&&$id!==!1&&$('label[for="'+$id+'"]').length>0){$('label[for="'+$id+'"]').prepend('<span></span>')}else{if($(this).parents('.wpcf7-checkbox').length==0){$(this).addClass('non-minimal')}}});$('.wpcf7-radio .wpcf7-list-item-label').each(function(i){var $data=$(this).html();var $name=$(this).parent().find('input').attr('name')+i;$(this).parent().find('input').attr('id',$name);$(this).replaceWith('<label for="'+$name+'">'+$data+'</label>')});$('.wpcf7-checkbox .wpcf7-list-item-label').each(function(){var $data=$(this).html();var $name=$(this).parent().find('input').attr('value');$(this).parent().find('input').attr('id',$name);$(this).replaceWith('<label for="'+$name+'"><span></span>'+$data+'</label>')});if($('.woocommerce-checkout #ship-to-different-address .woocommerce-form__label input[type="checkbox"]').length>0){var $shipToDifLabel=$('.woocommerce-checkout #ship-to-different-address .woocommerce-form__label');var $shipToDifInputClone=$shipToDifLabel.find('input[type="checkbox"]').removeClass('non-minimal').clone();var $shipToDifId=($shipToDifLabel.find('input[type="checkbox"][id]').length>0)?$shipToDifInputClone.attr('id'):'';$shipToDifLabel.find('span').contents().unwrap();$shipToDifLabel.prepend('<span></span>');$shipToDifLabel.attr('for',$shipToDifId);$shipToDifLabel.find('input[type="checkbox"]').remove();$shipToDifInputClone.insertBefore($shipToDifLabel)}
...
/* info: http://www.ergonrh.com.br/wp-includes/js/mediaelement/wp-mediaelement.min.js */
...
/* info: http://www.ergonrh.com.br/wp-content/themes/salient/js/flickity.min.js */
/*!
...
/* info: http://www.ergonrh.com.br/wp-content/plugins/js_composer_salient/assets/lib/bower/flexslider/jquery.flexslider-min.js */
/*
...
/* info: http://www.ergonrh.com.br/wp-content/themes/salient/js/stickkit.js */
...
return width}
return this}})(jQuery);
/* info: http://www.ergonrh.com.br/wp-content/themes/salient/js/touchswipe.min.js */
/* Touch swipe */
...
/* info: http://www.ergonrh.com.br/wp-content/plugins/wp-fastest-cache/js/toolbar.js */
...
/* info: http://www.ergonrh.com.br/wp-includes/js/mediaelement/mediaelement-and-player.min.js */
/*!
 * MediaElement.js
...
/* info: http://www.ergonrh.com.br/wp-includes/js/wp-embed.min.js */
...
/* info: http://www.ergonrh.com.br/wp-includes/js/underscore.min.js */
//     Underscore.js 1.8.3
...
/* info: http://www.ergonrh.com.br/wp-includes/js/backbone.min.js */
